...
import (
	...
	config2 "github.com/paust-team/pirius/agent/config"
...
var _ = Describe("IntegrationTest_WithDistributionRule", Ordered, func() {
	...
	Context("Publisher Scaling", Ordered, func() {
		var publishers []*agent.PubSubAgent
		var subscribers []*agent.PubSubAgent
		...
		AfterEach(func() {
			...
			publishers = []*agent.PubSubAgent{}
			subscribers = []*agent.PubSubAgent{}
